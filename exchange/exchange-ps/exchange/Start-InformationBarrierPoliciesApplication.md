...
### -CleanupGroupSegmentLink
The CleanupGroupSegmentLink is a Switch parameter for whether group segment links need to be removed or not. You don't need to specify a value with this switch.
